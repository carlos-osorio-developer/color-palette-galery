...
An app with creative color palette recommendations for every day.

You can check different color palettes, like or comment on them, and reserve them for your artistic work.
...
`git@github.com:carlos-osorio-developer/color-palette-galery.git`

- Go to the cloned directory:
`cd color-palette-galery`
